...
import copy
# ----------------------- PROVIDER CONFIG ----------------------------------- #
TYPE = os.getenv("LLM_PROVIDER", "DEEPINFRA")  # "GPT" or "DEEPINFRA" or "GEMINI"
...
if TYPE == "GPT":
    ...
    GEMINI_KEYS: List[str] = [
        "AIzaSyDeObaUq1mg4UvxjT44AwWcyG7TouV1AVg",
        "AIzaSyDeObaUq1mg4UvxjT44AwWcyG7TouV1AVg",
        "AIzaSyDeObaUq1mg4UvxjT44AwWcyG7TouV1AVg",
    ]
    ...
    raise ValueError(f"Unknown TYPE {TYPE!r}. Use 'GPT' or 'DEEPINFRA'.")
